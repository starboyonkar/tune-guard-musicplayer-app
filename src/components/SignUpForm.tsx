...
const SignUpForm: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const updateGradient = () => {
      ...
      root.style.setProperty('--dynamic-gradient', `linear-gradient(135deg, hsla(${hue1}, 80%, 70%, 0.8), hsla(${hue2}, 70%, 80%, 0.9))`);
    };
    updateGradient();
  ...
  return <div className="w-full max-w-md mx-auto p-6 animate-fade-in">
      ...
      <div className="ext-4xl font-bold mb-2 neon-text rounded-md bg-inherit">ʩ 2025 TUNE GUARD - OnkarNova Technologies Solapur, Maharashtra</div>
    </div>;
};
