          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-futuristic-muted">Name</Label>
                <Input
                  id="name"
              ...
              <div className="space-y-2">
                <Label htmlFor="age" className="text-futuristic-muted">Age</Label>
                <Input
                  id="age"
                  type="number"
              ...
              <div className="space-y-2">
                <Label htmlFor="gender" className="text-futuristic-muted">Gender</Label>
                <Select
                  value={gender}
